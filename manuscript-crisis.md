...
우린 노을 너머의 세계에 대해 아는 게 없는걸? 그리고 변해버린 잭에 대해서도.. 우리도 저렇게 변하면 어떡해...
```
...
```
```
응응! 난 말야, 미야미야님을 만나면 나를 평생 사랑해주는 가족을 찾게 해달라고 할꺼야!
```
```
...
아름다운 풍경 한가운데에 자리 잡고 있는 성의 대문은 어마 무시하게 컸다. 톰과 제리의 힘만으로는 대문을 열 수 없었다.
```
