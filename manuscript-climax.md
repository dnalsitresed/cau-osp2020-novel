...
톰은 마지막 순간 제리를 문 밖으로 보내고 털썩 주저 앉아 있었다.
...
그저 톰은 자신이 통과하지 못했다는 사실보다는 더 이상 제리와 함께가 아니라는 사실이 슬펐다.
...
반짝이는 눈빛 속 잭이 속아 넘어오지 않으면 어쩌나하는 불안함과 초조함이 있었지만 제리는 여유로운 미소로 이를 감추었다. 
미소를 띤 제리는 잭에게 말했다. 
...
변해버린 잭이었지만, 미야에 대한 마음만은 마치 옛날의 소중한 기억처럼 아니 끝끝내 잊을 수 없는 미련으로 남아있었다. 
...
하지만 주의할 점이 있단다. 
내가 이 작업을 하는 동안 절대 근처에 오면 안 된단다. 너희들이 산산조각 날 수도 있어. 물론 가설이지만...
```
제리와 잭은 긴장했다.
```
...
여기서 나갈 방법을 알고 있는 거야?
```
제리는 너무 많은 질문에 무엇을 먼저 말해야할지 곤란했다.
